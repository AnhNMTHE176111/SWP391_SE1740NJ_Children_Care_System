                ...
                <form class="login_form" action="login" method="post">
                    ...
                    <div>
                        ...
                        <button class="login_btn-2">
                            ...
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:9999/login-google&response_type=code&client_id=187601965794-m70hal4il0e70vohnl7qg1ij4vqtl6eq.apps.googleusercontent.com&approval_prompt=force" style="padding-left: 2px; color:#fff; text-decoration: none;"
