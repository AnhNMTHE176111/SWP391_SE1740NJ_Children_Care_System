                ...
                <form class="login_form" action="login" method="post">
                    ...
                    <div>
                        ...
                        <button class="login_btn-2">
                            ...
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:9999/SWP391_SE1740NJ_Children_Care_System/login&response_type=code&client_id=735170124292-pime0tfh1hos9ffg380454ugslgq0te8.apps.googleusercontent.com&approval_prompt=force" style="padding-left: 2px; color:#fff; text-decoration: none;"
