      ...
      <div class="background-img">
          ...
          <div class="side">
            <div>
              ...
              <div class="form-group label-box">
                ...
                >
                  <option class="option-box" value="1">
                    <ion-icon name="briefcase-outline"></ion-icon>Chọn chuyên
                    khoa
                  </option>
                  <option class="option-box" value="1">Chuyên khoa 1</option>
                  <option class="option-box" value="2">Chuyên khoa 2</option>
              ...
              <div class="form-group label-box">
                ...
                >
                  <option class="option-box" value="1">
                    <ion-icon name="person-outline"></ion-icon>Chọn bác sĩ muốn
                    khám
                  </option>
                  <option class="option-box" value="1">Mẹ của bạn</option>
                  <option class="option-box" value="2">???</option>
       ...
       <div class="date-select">
              ...
              <div class="date-hidden">
                <div class="date">
                  <button class="grid-date">08:00</button>
                  <button class="grid-date">08:30</button>
                  <button class="grid-date">09:00</button>
                  <button class="grid-date">09:30</button>
                  <button class="grid-date">10:00</button>
                  <button class="grid-date">10:30</button>
                  <button class="grid-date">11:00</button>
                  <button class="grid-date">13:00</button>
                  <button class="grid-date">13:30</button>
                  <button class="grid-date">14:00</button>
                  <button class="grid-date">14:30</button>
                  <button class="grid-date">15:00</button>
                  <button class="grid-date">15:30</button>
                  <button class="grid-date">16:00</button>
                </div>
              </div>
            </div>
          </div>
