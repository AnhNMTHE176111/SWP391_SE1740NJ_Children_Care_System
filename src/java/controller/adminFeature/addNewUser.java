...
public class addNewUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("admin_Dashboard_AddNewUser.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        User user = new User(status, firstName, lastName, gender, email, password, address, phone, dob, "image/profile_user/default.jpg", Integer.parseInt(roleid));
