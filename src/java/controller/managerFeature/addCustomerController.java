...
public class addCustomerController extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("manageAddNewCustomer.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        System.out.println("enter post addcustomer controller");
...
//        String roleid = request.getParameter("roleid");
        ...
        User user = new User(status, firstName, lastName, gender, email, password, address, phone, dob, "image/profile_user/default.jpg", 1);
        //If the above conditions are satisfied
        if (valid == true) {
            //Add a new user by email
            userDao.addNewAccountByAdmin(user);
